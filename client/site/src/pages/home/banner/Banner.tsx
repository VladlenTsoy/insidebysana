...
import {fetchBanners} from "../../../store/banner/fetchBanners"
import {useLoadingBanners, useSelectAllBanners} from "../../../store/banner/bannerSelector"
import {CarouselProvider, Slider, Slide, Dot} from "pure-react-carousel"

const Banner = () => {
    const dispatch = useDispatch()
    const banners = useSelectAllBanners()
    const loading = useLoadingBanners()
