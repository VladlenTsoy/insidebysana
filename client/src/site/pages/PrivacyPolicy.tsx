    ...
    return (
        <>
            ...
            <div className="container">
                ...
                закона «О персональных данных» от 2 июля 2019 года № ЗРУ-547 и определяет порядок обработки
                персональных данных и меры по обеспечению безопасности персональных данных Коденко Ляйсан
                Марселевна (далее – Оператор). <br />
                <ol>
                    <li>
                        {" "}
                    ...
                    <li>
                        ...
                        посетителях веб-сайта http://insidebysana.uz.
                    </li>
                </ol>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        или определяемому Пользователю веб-сайта http://insidebysana.uz;
                    </li>
                    <li> Пользователь – любой посетитель веб-сайта http://insidebysana.uz;</li>
                    <li>
                        {" "}
                ...
                <ol>
                    ...
                    <li>
                        ...
                        электронной почты sana@insidebysana.uz с пометкой «Отказ от уведомлениях о новых
                ...
                <ol>
                    <li>
                        ...
                        сайте http://insidebysana.uz. Заполняя соответствующие формы и/или отправляя свои
                ...
                <ol>
                    ...
                    <li>
                        ...
                        электронной почты Оператора sana@insidebysana.uz с пометкой «Актуализация персональных
                        данных».
                    </li>
                    <li>
                        {" "}
                        ...
                        sana@insidebysana.uz с пометкой «Отзыв согласия на обработку персональных данных».
                    </li>
                </ol>
